...
N0 = NFA({0,1,2},
	 ...
	 {(0,'0'): {11}} | {(11, letters): {12} for letters in octa_letters} | {(12, nums): {12,14} for nums in octa_digits} | {(12, '_'): {13}} |
	 {(13, nums): {14, 12} for nums in octa_digits} | {(14, nums): {14, 12} for nums in octa_digits} ,				# NFA for Octinteger
